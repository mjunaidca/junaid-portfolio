    ...
    return (
        <div>
            <div key='el' className="flex flex-col w-full pt-14 sm:pt-16 md:pt-20 lg:pt-28 xl:pt-36 2xl:pt-48 ">
                <div className=" text-[12px] sm:text-[15px] md:text-[18px] lg:[text-22px] font-semibold">
                    {call}
                </div>
                <div className="text-[32px] sm:text-[48px] md:text-[56px] lg:text-[64px] xl:text-[72px]  font-bold">
                    {head}
                </div>
                <div className="pt-1 text-[14px] sm:text-[15px] md:text-[18px] lg:[text-22px] relative">
                    {details}
                </div>
            </div>
        </div>
